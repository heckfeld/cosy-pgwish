    ...
    Axis *axisPtr;
{
	...
	/* Mike Mon Mai  3 08:50:30 CEST 2004
	   die Linux-x86 verhalten sich anders als HPUX-PA/RISC.
	   Die Ungenauigkeit bei DOUBLES wird hier jetzt aufgefangen.
 	 */
	if ((value < (minAxis-(axisPtr->step/2))) || (value > (maxAxis+(axisPtr->step/2)))) {
