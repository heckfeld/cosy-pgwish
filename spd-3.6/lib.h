...
#define OUTPUT_SCED      16 /* ScED External file format                   */
#define OUTPUT_VRML      17 /* VRML file format                            */
#define OUTPUT_DELAYED   18 /* Needed for RTRACE/PLG output.
...
/* unique object index for ScED */
extern int sced_index;
